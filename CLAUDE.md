...
- **[claude-code-slack](claude-code-slack/)** — Slack integration for Claude Code. See [claude-code-slack/CLAUDE.md](claude-code-slack/CLAUDE.md) for project-specific development reference.
