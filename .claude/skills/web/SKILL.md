...
- **Screenshots must be saved to `~/.yuki_workspace/attachments/`** with a date-prefixed filename:
  ```bash
  playwright-cli screenshot --filename=~/.yuki_workspace/attachments/YYYY-MM-DD-<descriptive-name>.png
  ```
